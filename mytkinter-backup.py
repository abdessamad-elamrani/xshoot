...
host_label = ttk.Label(root, text="Device Hostname/IP: ")
host_label.pack()
...
FolderPath_label = ttk.Label(root, text="Select where to save logs: ")
FolderPath_label.pack()
##### Button to select Folder
FolderPath_button = ttk.Button(root, text="Browse Folder", command=getFolderPath)
FolderPath_button.pack()
